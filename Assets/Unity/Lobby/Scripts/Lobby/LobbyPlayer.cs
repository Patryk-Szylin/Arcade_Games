...
namespace Prototype.NetworkLobby
{
    ...
    public class LobbyPlayer : NetworkLobbyPlayer
    {
        ...
        [ClientRpc]
        void RpcChangeSprite(int indx)
        {
            ChangeSprite(indx);
        }

        [Command]
        public void CmdChangeSprite(int indx)
        {
            CharacteSelectrBtn.GetComponent<Image>().overrideSprite = characterSprites[indx];
        }

        void ChangeSprite(int index)
        {
            CharacteSelectrBtn.GetComponent<Image>().overrideSprite = characterSprites[index];
        }
        //
        ...
        void AvatarPicker(string buttonName)
        {
            ...
            spriteIndex = avatarIndex;

            if (isServer)
            {
                RpcChangeSprite(spriteIndex);
            }
            else
            {
                CmdChangeSprite(spriteIndex);
